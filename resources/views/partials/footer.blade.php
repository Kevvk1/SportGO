        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3 g-0">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <p style="color: white;"><i class="fas fa-phone me-3" style="color: white;"></i> + 54 9 11 1234 5678</p>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    <!-- Links -->
                    <h6 class="text-uppercase fw-bold mb-4" style="color: white; margin-top: 5em;">
                        Enlaces
                    </h6>
                    <p>
                        <a href="#!" style="color: white;">Acerca de</a>
                    </p>
                    <p>
                    ...
                    <p>
                        <a href="#!" style="color: white;">Dudas frecuentes</a>
                    </p>
                </div>
                <!-- Grid column -->
                <div class="vr" style="color: white;"></div>
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    <!-- Links -->
                    <h6 class="text-uppercase fw-bold mb-4" style="color: white; margin-top: 5em;">Redes sociales</h6>
