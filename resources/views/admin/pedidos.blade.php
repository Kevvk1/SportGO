...
@section('main')
    <h1 class="mt-3 text-center">Listado de pedidos pendientes</h1>
    @if($pedidos->isEmpty())
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form id="entregarPedido-form" action="{{ route('pedido.entregar') }}" method="POST">
                            @csrf
                            <!-- Campo oculto para código del producto -->
                            <input type="hidden" name="id_pedido" value="{{ $pedido->id_pedido }}">
                            <button type="submit" class='btn btn-success' id='boton_entregar_pedido' name='boton_entregar_pedido'>
                                <h6>Marcar como entregado</h6>
                            </button>
                        </form>
                    </td>
