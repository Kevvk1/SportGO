            ...
            <div class="col-12 my-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12 my-4">
                        ...
                        <input type="text" name="stock_producto" id="stock_producto" class="form-control" aria-label="Stock del producto" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-sm-12 my-4">
                ...
                <div class="row">
                    <div class="col-12 my-4">
                            <label for="imagen_producto" class="form-label">Adjunte imagen del producto</label>
                ...
                <div class="row">
                    <div class="col-12 my-5">
                        <button type="submit" class="btn" id="loginbutton" value="cargar" name="action"> 
                            <h5>Cargar</h5>
                        </button>
                    </div>
                </div>
